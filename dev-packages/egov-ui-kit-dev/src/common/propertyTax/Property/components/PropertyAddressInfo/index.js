 ...
 // const localityCode =address && address.locality && address.locality.code ? address.locality.code : 'NA';
  ...
  return (
    properties && [
      ...
      {
        key: "Premise Number",
        value: properties.premisesNo || "NA",
        oldValue: OldProperty && OldProperty.properties && OldProperty.properties.premisesNo
      },
  
      {
        key: "Premise Type",
        value: properties.premisesType || "NA",
        oldValue: OldProperty && OldProperty.properties && OldProperty.properties.premisesType
      },
