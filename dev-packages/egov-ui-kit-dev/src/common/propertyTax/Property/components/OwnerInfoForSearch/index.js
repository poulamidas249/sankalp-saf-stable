...
export const getOwnershipTypeInfo = (institution, generalMDMSDataById) => {
  return (
    (institution &&
      ...
      generalMDMSDataById["SubOwnerShipCategory"][institution.type].userName) ||
    "NA"
  );
};
...
export const getOwnershipInfoUserCategory = (owner, generalMDMSDataById, localizationLabelsData) => {
  return (
    (owner &&
      ...
      // generalMDMSDataById["OwnerType"][owner.ownerType].userName) ||
      getLocaleLabels(
...
export const getOwnerInfo = (latestPropertyDetails, generalMDMSDataById, oldPropertydetails = {}) => {
  ...
  let owner = [];
  ownerDetails = ownerDetails && Array.isArray(ownerDetails) && ownerDetails.sort((owner1, owner2) => owner1.userName.localeCompare(owner2.userName));
  ...
  if (oldPropertydetails && oldPropertydetails.owners) {
    oldPropertydetails.owners =
      ...
      oldPropertydetails.owners.sort((owner1, owner2) => owner1.userName.localeCompare(owner2.userName));
  }
        ...
        items: [
          isInstitution
            ? {
                ...
                value: (institution && institution.userName) || "NA",
                oldValue: oldPropertydetails && oldPropertydetails.institution && oldPropertydetails.institution.userName,
              }
            : {
                key: getTranslatedLabel("PT_OWNERSHIP_INFO_NAME", localizationLabelsData),
                value: owner.userName || "NA",
                oldValue: oldPropertydetails && oldPropertydetails.owners && oldPropertydetails.owners[index].userName,
              },
          isInstitution
            ? {
          ...
          },
          {
            ...
            oldValue:
              oldPropertydetails && oldPropertydetails.owners && Array.isArray(oldPropertydetails.owners) && oldPropertydetails.owners[index].policeStation,
          },
          {
            key: "Post Office",
            value: owner.postOffice ? owner.postOffice || "NA" : "",
            oldValue:
              oldPropertydetails && oldPropertydetails.owners && Array.isArray(oldPropertydetails.owners) && oldPropertydetails.owners[index].postOffice,
          },
          isInstitution
            ? {
            ...
            : {
                ...
                oldValue:
                  ...
                  oldPropertydetails.owners &&
                  Array.isArray(oldPropertydetails.owners) &&
                  oldPropertydetails.owners[index].address,
              },
          ...
          //         oldPropertydetails.owners &&
          //         Array.isArray(oldPropertydetails.owners) &&
          //         oldPropertydetails.owners[index].userName,
          //     }
          //   : {
...
class OwnerInfo extends Component {
  ...
  transformData = (property) => {
    ...
    owners.map((item) => {
      ...
      if (institution) {
        owner = {
          PT_OWNERSHIP_INFO_NAME_INSTI: institution.userName || "NA",
        ...
        owner = {
          PT_OWNER_NAME: item.userName || "NA",
          ...
          PT_OWNERSHIP_INFO_CORR_ADDR: item.address || "NA",
        };
