    ...
    ownerDetails.map((owner, index) => {
      return {
        items: [
          ...
          {
            key: "Pin",
            value: owner.pincode ? owner.pincode || "NA" : "",
            oldValue:
              oldPropertydetails && oldPropertydetails.owners && Array.isArray(oldPropertydetails.owners) && oldPropertydetails.owners[index].pincode,
          },
          {
            key: "Ownership Category",
            value: latestPropertyDetails.ownerShipCategoryDropDown ? latestPropertyDetails.ownerShipCategoryDropDown || "NA" : "",
            oldValue:
              oldPropertydetails && oldPropertydetails.ownerShipCategoryDropDown 
          },
        
          {
            key: "Liable To Pay Tax",
            value: latestPropertyDetails.personLiableToPayTax ? latestPropertyDetails.personLiableToPayTax || "NA" : "",
            oldValue:
              oldPropertydetails && oldPropertydetails.personLiableToPayTax 
          },
