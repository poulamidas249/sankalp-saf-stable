  ...
  render() {
    ...
    if (purpose === PROPERTY_FORM_PURPOSE.CREATE && status === "success") {
      ...
      ptMsg = {
        ...
        labelKey: "New Property Application Submitted Successfully",
      };
      process.env.REACT_APP_NAME === "Citizen" ? ptSubMsg = {
        labelName: "Draft Assessee number is generated for given application",
        labelKey: "Draft Assessee number is generated for given application",
      } : ptSubMsg = {
        labelName: "Assessee number is generated for given application",
        labelKey: "Assessee number is generated for given application",
      };
      statusIcon = {
        icon: "done",
        iconColor: "#39CB74",
      ...
      Button1 = { name: "HOME", buttonClick: this.onGoHomeClick, visibility: true };
      ...
      ptMsg = {
        labelName: "Property Application Approved Successfully",
        labelKey: "Property Application Approved Successfully",
      };
      ptSubMsg = {
        labelName: "185 Notice has been sent to Citizen.",
        labelKey: "185 Notice has been sent to Citizen.",
      };
      statusIcon = {
        icon: "done",
        iconColor: "#39CB74",
      ...
      ptMsg = {
        ...
        labelKey: "New Property Application Submission Failed",
      };
      ptIDLabel = {
      ...
      ptSubMsg = {
        ...
        labelKey: "A notification regarding new property application has been sent to property owner at registered Mobile No.",
      };
      ...
      Button2 = { name: "HOME", buttonClick: this.onGoHomeClick, visibility: true };
      // downloadButton={menu:downloadMenu,visibility:true} ;
      // printButton={menu:printMenu,visibility:true} ;
    ...
    return (
      <div>
        <div className="mainContainer flex-container">
          <PTHeader header={ptHeader && ptHeader.labelKey} />
          {/* <Label
