...
class PTInformation extends React.Component {
  ...
  render() {
    ...
    if (properties.status == "INWORKFLOW") {
      ...
      properties.owners = updatedOnwerInfo.owners;
      properties.institution = updatedOnwerInfo.institution;
      properties.ownershipCategory = updatedOnwerInfo.ownershipCategory;
    }
    return (
