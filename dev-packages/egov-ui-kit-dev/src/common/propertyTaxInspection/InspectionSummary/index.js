...
import TaxCalculationDetailInfo from "../Property/components/TaxInfo";
import "./index.css";
import { routeTo } from "../../../utils/PTCommon/FormWizardUtils/formActionUtils";
...
class ApplicationPreview extends Component {
  ...
  onEditButtonClick = (index) => {
    ...
    console.log("On click edit button");
    routeTo("/inspection-assessment-form");
    onTabClick(index);
  };
  ...
  render() {
    ...
    let objectProperty = {
      ...
      owners: [
        {
          ...
          fatherOrHusbandName: "Asit Debata",
          emailId: "asit@gmail.com",
      ...
      address: {
        ownerShipCategoryDropDown: "Bustee Premises",
      },
      taxdetails: {
        propsedQTR: "1",
        propsedYear: "2021",
                ...
                textChildren={
                  <div className="col-sm-12 col-xs-12" id="property-application-review-form" style={{ alignItems: "center" }}>
                    ...
                    <RegistrationDetailInfo
                      properties={objectProperty}
                      generalMDMSDataById={generalMDMSDataById}
                      editIcon={<EditIcon onIconClick={() => onEditButtonClick(3)} />}
                    ></RegistrationDetailInfo>

                    <TaxCalculationDetailInfo
                      properties={objectProperty}
                      generalMDMSDataById={generalMDMSDataById}
                      editIcon={<EditIcon onIconClick={() => onEditButtonClick(4)} />}
                    ></TaxCalculationDetailInfo>
                  </div>
                }
              />
