...
export const getOwnerInfo = (properties, generalMDMSDataById, OldProperty) => {
  // const isInstitution =
  ...
  //         {
  //           key: "Pin",
  //           value: owner.pin ? owner.pin || "NA" : "",
  //           oldValue:
  //             oldPropertydetails && oldPropertydetails.owners && Array.isArray(oldPropertydetails.owners) && oldPropertydetails.owners[index].pin,
  //         },
  //         {
  //           key: "Police Station",
  //           value: owner.policeStation ? owner.policeStation || "NA" : "",
  //           oldValue:
  //             oldPropertydetails &&
  //             oldPropertydetails.owners &&
  //             Array.isArray(oldPropertydetails.owners) &&
  //             oldPropertydetails.owners[index].policeStation,
  //         },
  //         {
  //           key: "Post Office",
  //           value: owner.postOffice ? owner.postOffice || "NA" : "",
  //           oldValue:
  //             oldPropertydetails &&
  //             oldPropertydetails.owners &&
  //             Array.isArray(oldPropertydetails.owners) &&
  //             oldPropertydetails.owners[index].postOffice,
  //         },
  //         isInstitution
  //           ? {
  ...
  const ownerDetails = owners && owners.length > 0 ? owners[0] : [];
  ...
  return (
    ownerDetails && [
      {
        key: "Name",
        value: ownerDetails.userName || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].userName,
      },
      {
        key: "Guardian Name",
        value: ownerDetails.fatherOrHusbandName || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].fatherOrHusbandName,
      },
      {
        key: "Gender",
        value: ownerDetails.gender || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].gender,
      },
      {
        key: "Ownership Type",
        value: properties.ownershipType || "NA",
        oldValue: OldProperty && OldProperty.ownershipType,
      },
      {
        key: "Mobile Number",
        value: ownerDetails.mobileNumber || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].mobileNumber,
      },

      {
        key: "Email Id",
        value: ownerDetails.emailId || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].emailId,
      },
      {
        key: "Pin",
        value: ownerDetails.pincode || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].pincode,
      },
      {
        key: "Police Station",
        value: ownerDetails.policeStation || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].policeStation,
      },
      {
        key: "Post Office",
        value: ownerDetails.postOffice || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].postOffice,
      },
      {
        key: "Permanent Address",
        value: ownerDetails.permanentAddress || "NA",
        oldValue: OldProperty && Object.keys(OldProperty).length > 0 && OldProperty.owners[0].permanentAddress,
      },
    ]
  );
};
...
class OwnerInfo extends Component {
  ...
  render() {
    ...
    //   oldPropertydetails = OldProperty;
    // }

    if (properties) {
      if (properties.owners.length > 0) {
        ownerInfo = getOwnerInfo(properties, OldProperty);
      }
      // const { owners } = properties;
      // console.log({ owners });
      // if (owners && owners.length > 0) {
      //   ownerInfo = OldProperty ? getOwnerInfo(properties, generalMDMSDataById, OldProperty) : getOwnerInfo(properties, generalMDMSDataById);
    ...
    return <PropertyInfoCard editIcon={editIcon} items={ownerInfo} header={header}></PropertyInfoCard>;
    // return (
    //   <div>
    //     {ownerInfo && (
    //       <Card
