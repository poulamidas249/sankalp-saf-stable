...
import { convertToOldPTObject , convertToOldPTObjectNew } from "egov-ui-kit/utils/PTCommon/FormWizardUtils/formUtils";
...
export const getCreatePropertyResponse = (createPropertyResponse) => {
  ...
  try {
    return { Properties: convertToOldPTObjectNew(createPropertyResponse), newProperties: createPropertyResponse.Properties };
  } catch (e) {
    console.error(e);
