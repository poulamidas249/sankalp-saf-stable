...
export const getGeneralMDMSDataDropdownName = () => {
  let keys = ["Floor", "OccupancyType", "OwnerShipCategory", "OwnerType", "PropertySubType", "PropertyType", "SubOwnerShipCategory", "UsageCategory", "characterOfPremiseType","buildingType","PremisesType","OwnershipType" , "ward"];
  return keys;
};
