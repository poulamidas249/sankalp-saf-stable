...
export const convertToOldPTObjectNew = (newObject) => {
  let Properties = [
    {
      address: null,
      officeCode: null,
  ...
  let property = {};
  let propertyDetails = {};
  property.owners = newProperty.owners;
  property.buildingdetails = newProperty.buildingdetails;
  property.registrationDetails = newProperty.registrationDetails;

  property.premisesType = newProperty.premisesType;
  property.premisesNo = newProperty.premisesNo;
  property.ward = newProperty.ward;
  property.street = newProperty.street;

  property.ownershipCategory = newProperty.ownershipCategory;
...
export const propertySubmitAction = (Properties, action, props, isModify, preparedFinalObject) => {
  ...
  switch (purpose) {
    ...
    case PROPERTY_FORM_PURPOSE.SENDFOREDIT:
      ...
      break;
    case PROPERTY_FORM_PURPOSE.APPROVE:
      createProperty(Properties, '_update', props, isModify, preparedFinalObject);
      break;
    default:
      createProperty(Properties, '_create', props);
