...
export const parkingAreaAllocationCard = getCommonCard({
  ...
  searchContainer: getCommonContainer({
    ...
    contractId: getSelectField({
      ...
      data: [{ code: "demo Contract", name: "demo Contract" }],
    }),
    agencyId: getSelectField({
      label: {
        labelName: "Agency Id",
        labelKey: "Agency Id",
      },
      ...
      data: [{ code: "Demo Agency", name: "Demo Agency" }],
    }),
  }),
