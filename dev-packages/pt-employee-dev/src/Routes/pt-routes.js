...
const SafPreview = Loadable({
  loader: () => import("egov-ui-kit/common/propertyTax/ApplicationPreviewSaf"),
  loading: Loading
});
...
const InspectionFormWizard = Loadable({
  loader: () => import("../Screens/InspectionFormWizard"),
  loading: Loading,
});
...
const routes = [
  ...
  {
    path: "property-tax/saf-preview",
    component: SafPreview,
    needsAuthentication: true,
    options: {
      // hideTitle:true,
      hideFooter: true,
  ...
  {
    path: "property-tax/inspection-summary",
    component: InspectionFormWizard,
    needsAuthentication: true,
    options: {
      // hideTitle:true,
      hideFooter: true,
  ...
  {
    path: "property-tax/inspection-assessment-form",
    component: InspectionFormWizard,
    needsAuthentication: true,
    options: {
      hideFooter: true,
