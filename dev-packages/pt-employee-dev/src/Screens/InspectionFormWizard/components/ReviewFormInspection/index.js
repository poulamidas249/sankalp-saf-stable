...
import RegistrationDetailInfo from "egov-ui-kit/common/propertyTaxInspection/Property/components/RegistrationDetailInfo";
import LandDetailsInfo from "egov-ui-kit/common/propertyTaxInspection/Property/components/LandDetailsInfo";
import BuildingDetailsInfo from "egov-ui-kit/common/propertyTaxInspection/Property/components/BuildingDetailsInfo";
import TaxCalculationDetialInfo from "egov-ui-kit/common/propertyTaxInspection/Property/components/TaxCalculationDetialInfo";
import DocumentsInfo from "egov-ui-kit/common/propertyTax/Property/components/DocumentsInfo";
import OwnerInfo from "egov-ui-kit/common/propertyTaxInspection/Property/components/OwnerInfo";
import PropertyAddressInfo from "egov-ui-kit/common/propertyTaxInspection/Property/components/PropertyAddressInfo";
...
const AddRebatePopUp = formHoc({
  formKey: "additionalRebate",
  path: "PropertyTaxPay",
})(AddRebateExemption);

class ReviewFormInspection extends Component {
  state = {
    valueSelected: "",
    showRebateBox: false,
  ...
  onEditButtonClick = (index) => {
    ...
    prepareFinalObject("showSummary", false);
            ...
            >
              <div>
                <Label
                  ...
                  label={"Assessee Summary"}
                  fontSize="20px"
                />
              </div>
              {formWizardConstants[purpose].isEstimateDetails && (
              ...
              <PropertyAddressInfo
                ...
                editIcon={
                  formWizardConstants[purpose].isEditButton ? (
                    <EditIcon onIconClick={() => onEditButtonClick(0)} />
                  ) : null
                }
              ></PropertyAddressInfo>
              ...
              <OwnerInfo
                ...
                properties={this.props.properties}
                editIcon={
                  formWizardConstants[purpose].canEditOwner ? (
                    <EditIcon onIconClick={() => onEditButtonClick(1)} />
                  ) : null
                }
              ></OwnerInfo>
              ...
              <LandDetailsInfo
                ...
                editIcon={
                  formWizardConstants[purpose].isEditButton ? (
                    <EditIcon onIconClick={() => onEditButtonClick(2)} />
                  ) : null
                }
              ></LandDetailsInfo>
              <BuildingDetailsInfo
              ...
              <RegistrationDetailInfo
                ...
                editIcon={
                  formWizardConstants[purpose].isEditButton ? (
                    <EditIcon onIconClick={() => onEditButtonClick(3)} />
                  ) : null
                }
              ></RegistrationDetailInfo>

              <TaxCalculationDetialInfo
                OldProperty={OldProperty}
                generalMDMSDataById={generalMDMSDataById}
                properties={this.props.properties}
                editIcon={
                  formWizardConstants[purpose].isEditButton ? (
                    <EditIcon onIconClick={() => onEditButtonClick(4)} />
                  ) : null
                }
              ></TaxCalculationDetialInfo>
