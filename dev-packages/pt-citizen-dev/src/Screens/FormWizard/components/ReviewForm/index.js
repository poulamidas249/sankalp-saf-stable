...
import RoomDetailInfo from 'egov-ui-kit/common/propertyTax/Property/components/RoomDetailInfo';
import PropDetailInfo from 'egov-ui-kit/common/propertyTax/Property/components/PropDetailInfo';
import BuildingDetailsInfoSummary from 'egov-ui-kit/common/propertyTax/Property/components/BuildingDetailsInfoSummary';
        ...
        <Card
          textChildren={
            <div className="col-sm-12 col-xs-12" style={{ alignItems: "center" }}>
              ...
              <OwnerInfo OldProperty={OldProperty} generalMDMSDataById={generalMDMSDataById} properties={this.props.properties} editIcon={formWizardConstants[purpose].canEditOwner ? <EditIcon onIconClick={() => onEditButtonClick(1)} /> : null}></OwnerInfo>
              ...
              <LandDetailsInfo OldProperty={OldProperty} generalMDMSDataById={generalMDMSDataById} properties={this.props.properties} editIcon={formWizardConstants[purpose].isEditButton ? <EditIcon onIconClick={() => onEditButtonClick(2)} /> : null}></LandDetailsInfo>
              <BuildingDetailsInfoSummary OldProperty={OldProperty} generalMDMSDataById={generalMDMSDataById} properties={this.props.properties} editIcon={formWizardConstants[purpose].isEditButton ? <EditIcon onIconClick={() => onEditButtonClick(2)} /> : null}></BuildingDetailsInfoSummary>
              <RegistrationDetailInfo OldProperty={OldProperty} generalMDMSDataById={generalMDMSDataById} properties={this.props.properties} editIcon={formWizardConstants[purpose].isEditButton ? <EditIcon onIconClick={() => onEditButtonClick(4)} /> : null}></RegistrationDetailInfo>
              <PropDetailInfo OldProperty={OldProperty} generalMDMSDataById={generalMDMSDataById} properties={this.props.properties} editIcon={formWizardConstants[purpose].isEditButton ? <EditIcon onIconClick={() => onEditButtonClick(3)} /> : null}></PropDetailInfo>
              <RoomDetailInfo OldProperty={OldProperty} generalMDMSDataById={generalMDMSDataById} properties={this.props.properties} editIcon={formWizardConstants[purpose].isEditButton ? <EditIcon onIconClick={() => onEditButtonClick(3)} /> : null}></RoomDetailInfo>
              <DocumentsInfo generalMDMSDataById={generalMDMSDataById} documentsUploaded={this.props.documentsUploadRedux} editIcon={formWizardConstants[purpose].isEditButton ? <EditIcon onIconClick={() => onEditButtonClick(5)} /> : null}></DocumentsInfo>
            </div>
          }
        />
