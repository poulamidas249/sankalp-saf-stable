...
import {
  InstitutionAuthorityHOC, InstitutionHOC, OwnerInfoHOC, PropertyDetailsHOC,
  PropertyAreaDetailsHOC,
  RoomPropertyDetails, OwnerInformation, LandDetailsHOC, OwnershipTypeHOC, PropertyRegistrationDetails, BuildingDetailsHOC, PropertyAddressHOC, TaxCalculationHOC, UsageInformationHOC
...
class FormWizard extends Component {
  ...
  fetchDraftDetails = async () => {
    ...
    try {
      ...
      searchPropertyResponse.Properties[0] = { ...searchPropertyResponse.Properties[0], propertyDetails }
