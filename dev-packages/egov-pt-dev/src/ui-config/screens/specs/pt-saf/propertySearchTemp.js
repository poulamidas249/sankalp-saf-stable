...
import { cityChange, resetFields } from "./tempMutation-methods";
import propertySearchTabs from "./property-search-tabs";
import { searchApplicationTable, searchPropertyTable } from "./searchResource/tempSearchResult";
import { searchPropertyDetails, searchApplicationDetails } from "./tempMutation-methods";
...
const header = getCommonHeader({
  labelName: "Search for Draft Assessee",
  labelKey: "Search for Draft Assessee"
});
const screenConfig = {
  uiFramework: "material-ui",
  name: "propertySearchTemp",
