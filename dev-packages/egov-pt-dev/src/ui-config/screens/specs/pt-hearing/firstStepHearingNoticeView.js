...
const getNoticeNo = (action, state, dispatch) => {
  let noticeNo = get(
    ...
    "firstStepHearingNoticeView.noticeNo",
    ""
  );
...
const getStreet = (action, state, dispatch) => {
  let street = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.street",
    ""
  );
...
const getownerName = (action, state, dispatch) => {
  let ownerName = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.ownerName",
    ""
  );
...
const getAssesseeNo = (action, state, dispatch) => {
  let assesseeNo = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.assesseeNo",
    ""
  );
...
const getWardNo = (action, state, dispatch) => {
  let wardNo = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.wardNo",
    ""
  );
...
const getExistingAV = (action, state, dispatch) => {
  let existingAV = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.existingAV",
    ""
  );
...
const getExistingQTR = (action, state, dispatch) => {
  let existingQTR = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.existingQTR",
    ""
  );
...
const getPremiseNo = (action, state, dispatch) => {
  let premiseNo = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.premiseNo",
    ""
  );
...
const getDivision = (action, state, dispatch) => {
  let division = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.division",
    ""
  );
...
const getExistingCommAV = (action, state, dispatch) => {
  let existingCommAV = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.existingCommAV",
    ""
  );
...
const getAppFlag = (action, state, dispatch) => {
  let appFlag = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.appFlag",
    ""
  );
...
const getSinedie = (action, state, dispatch) => {
  let sinedie = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.sinedie",
    ""
  );
...
const getHearingDate = (action, state, dispatch) => {
  let hearingDate = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.hearingDate",
    ""
  );
...
const getReason = (action, state, dispatch) => {
  let reason = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.reason",
    ""
  );
...
const getNoticeSection = (action, state, dispatch) => {
  let noticeSection = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.noticeSection",
    ""
  );
...
const getProposedCommAV = (action, state, dispatch) => {
  let proposedCommAV = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.proposedCommAV",
    ""
  );
...
const getProposedAV = (action, state, dispatch) => {
  let proposedAV = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.proposedAV",
    ""
  );
...
const getgrIR = (action, state, dispatch) => {
  let grIR = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.grIR",
    ""
  );
...
const getHearingReason = (action, state, dispatch) => {
  let hearingReason = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.hearingReason",
    ""
  );
...
const getProposedQTR = (action, state, dispatch) => {
  let proposedQTR = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.proposedQTR",
    ""
  );
...
const getHearingTime = (action, state, dispatch) => {
  let hearingTime = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.hearingTime",
    ""
  );
...
const getHearingOffer = (action, state, dispatch) => {
  let hearingOffer = get(
    state.screenConfiguration.preparedFinalObject,
    "firstStepHearingNoticeView.hearingOffer",
    ""
  );
  dispatch(prepareFinalObject("hearingOffer", hearingOffer));
};

const firstStepHearingNoticeView = getCommonCard({
  firstStepHearingNoticeViewContainer: getCommonContainer({
    ...
    sinedie: getSelectField({
      ...
      required: false,
      visible: true,
      jsonPath: "firstStepHearingNoticeView.sinedie",
      // afterFieldChange: (action, state, dispatch) => {
    ...
    hearingReason: getSelectField({
      ...
      required: false,
      visible: true,
      jsonPath: "firstStepHearingNoticeView.reason",
      ...
      afterFieldChange: (action, state, dispatch) => {
        ...
        dispatch(prepareFinalObject("firstStepHearingNoticeView.hearingReason", hearingReason[0].value));
           
          },
      gridDefination: {
        xs: 12,
    ...
    hearingOfficer: {
      ...
      props: {
        ...
        afterFieldChange: (action, state, dispatch) => {
          ...
                state.screenConfiguration.preparedFinalObject,
                "firstStepHearingNoticeView.hearingOfficer",
                ""
              );
          ...
          dispatch(prepareFinalObject("firstStepHearingNoticeView.hearingOfficer", hearingOfficer[0].value));
             
            },
    ...
    noticeSection: getSelectField({
      ...
      afterFieldChange: (action, state, dispatch) => {
        ...
        dispatch(prepareFinalObject("firstStepHearingNoticeView.noticeSection", noticeSection[0].value));
           
          },
      gridDefination: {
        xs: 12,
    ...
    hearingTime: getTimeField({
      ...
      props: {
        className: "tl-trade-type",
        jsonPathUpdatePrefix: "firstStepHearingNoticeView.hearingTime",
        jsonPath: "firstStepHearingNoticeView.hearingTime",
        defaultValue: "00:00",
...
export default firstStepHearingNoticeView;
