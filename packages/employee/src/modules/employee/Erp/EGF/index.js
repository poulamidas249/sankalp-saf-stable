...
class EGFFinance extends Component {
  constructor(props) {
    ...
    console.log("this.onFrameLoad=", this.onFrameLoad);
    console.log("this.resetIframe=", this.resetIframe);
  }
  onFrameLoad() {
  ...
  render() {
    ...
    erp_url = loc.protocol + "//" + "kolkatamc.ddns.net" + menuUrl;
