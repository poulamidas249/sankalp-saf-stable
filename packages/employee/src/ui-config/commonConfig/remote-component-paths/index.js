const remoteComponentPath = (moduleName, path) => {
  ...
  switch (moduleName) {
    ...
    case "egov-parking":
      if (path === "ui-atoms-local") {
        component = import("egov-parking/ui-atoms-local");
      } else if (path === "ui-molecules-local") {
        component = import("egov-parking/ui-molecules-local");
      } else if (path === "ui-containers-local") {
        component = import("egov-parking/ui-containers-local");
      }
      break;
    // case "egov-grievance":
    //   if (path === "ui-atoms-local") {
    //     component = import("egov-grievance/ui-atoms-local");
    //   } else if (path === "ui-molecules-local") {
    //     component = import("egov-grievance/ui-molecules-local");
    //   } else if (path === "ui-containers-local") {
    //     component = import("egov-grievance/ui-containers-local");
    //   }
    //   break;
